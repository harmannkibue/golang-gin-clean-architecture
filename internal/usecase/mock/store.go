...
func (m *MockStore) CreateBlog(arg0 context.Context, arg1 sql.NullString) (db.Blog, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListBlog(arg0 context.Context, arg1 db.ListBlogParams) ([]db.Blog, error) {
	m.ctrl.T.Helper()
